...
player_image = pygame.image.load(os.path.join("Assets","rocketship.png"))
...
letter_images = [pygame.image.load(os.path.join("Assets","A.png")), pygame.image.load(os.path.join("Assets","B.png")),
                 pygame.image.load(os.path.join("Assets","C.png")), pygame.image.load(os.path.join("Assets","D.png")),
                 pygame.image.load(os.path.join("Assets","E.png")), pygame.image.load(os.path.join("Assets","F.png")),
                 pygame.image.load(os.path.join("Assets","G.png"))]
